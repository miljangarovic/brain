...
describe('TabBar', () => {
  it('renders a tab per terminal and marks the active one', () => {
    render(<TabBar terminals={terms} activeId="a" viewMode="tabs" onToggleView={noop} onSelect={noop} onClose={noop} onAdd={noop} onLaunch={noop} />)
  ...
  it('calls onSelect when a tab is clicked', async () => {
    ...
    render(<TabBar terminals={terms} activeId="a" viewMode="tabs" onToggleView={noop} onSelect={onSelect} onClose={noop} onAdd={noop} onLaunch={noop} />)
  ...
  it('calls onClose without selecting when the × is clicked', async () => {
    const onSelect = vi.fn()
    const onClose = vi.fn()
    render(<TabBar terminals={terms} activeId="a" viewMode="tabs" onToggleView={noop} onSelect={onSelect} onClose={onClose} onAdd={noop} onLaunch={noop} />)
  ...
  it('calls onAdd when + is clicked', async () => {
    const onAdd = vi.fn()
    render(<TabBar terminals={terms} activeId="a" viewMode="tabs" onToggleView={noop} onSelect={noop} onClose={noop} onAdd={onAdd} onLaunch={noop} />)
  ...
  it('launches an agent via its quick button', async () => {
    ...
    render(<TabBar terminals={terms} activeId="a" viewMode="tabs" onToggleView={noop} onSelect={noop} onClose={noop} onAdd={noop} onLaunch={onLaunch} />)
  ...
  it('shows the kind icon on an agent tab', () => {
    ...
    render(<TabBar terminals={agentTerms} activeId="a" viewMode="tabs" onToggleView={noop} onSelect={noop} onClose={noop} onAdd={noop} onLaunch={noop} />)
