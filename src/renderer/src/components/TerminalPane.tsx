...
export function TerminalPane({
  terminal, active, gridded, gridRowSpan, gridColSpan, visibleInTabs, busy, liveAgent, reviewStatus, onActivate, dnd, resume, started, onStart, onOpenFile, onSessionFallback
}: {
  terminal: Terminal
  active: boolean
