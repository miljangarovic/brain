...
export function ExportToast({ progress, notice, onDismiss }: {
  ...
  return (
    <div role="status" aria-live="polite" aria-atomic="true" className="fixed bottom-3 right-3 z-50 flex max-w-md items-center gap-2 rounded-md border border-line bg-elevated px-3 py-2 text-sm text-fg shadow-xl shadow-black/50">
      {progress ? (
        <>
