...
export function ReviewStatusDot({ status }: { status: ReviewStatus | undefined }) {
  ...
  if (dot === 'done') return <span data-testid="review-done" title="Review prošao" className="shrink-0 h-2 w-2 rounded-full bg-green-400 shadow-[0_0_6px_rgba(74,222,128,0.7)]" />
